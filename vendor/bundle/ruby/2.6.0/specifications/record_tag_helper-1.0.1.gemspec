# -*- encoding: utf-8 -*-
# stub: record_tag_helper 1.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<actionview>.freeze, [">= 5"])
    s.add_development_dependency(%q<actionpack>.freeze, [">= 5"])
    s.add_development_dependency(%q<activemodel>.freeze, [">= 5"])
    s.add_development_dependency(%q<rake>.freeze, ["~> 10.4"])
    s.add_development_dependency(%q<mocha>.freeze, ["~> 1.1.0"])
  else
    s.add_dependency(%q<actionview>.freeze, [">= 5"])
